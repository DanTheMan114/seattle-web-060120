...
Questions: 
- How do you know when to write a custom route?
- default for activation
- route -> the route would be set up, how to render with other parts not breaking. 
- default value -> going to /active to toggle.
